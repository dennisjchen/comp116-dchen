...
3. Briefly describe why the protocol used to transfer the files is insecure?
	FTP cannot encrypt its data because the data is in plain-text
4. What is the secure alternative to the protocol used to transfer files?
	Theres many options like SFTP
5. What is the IP address of the server?
	67.23.79.113
6. What was the username and password used to access the server?
	username: stokerj, password w00tfu!
7. How many files were transferred from PC to server?
	3 files
8. What are the names of the files transferred from PC to server?
	STOR code.rtf, STOR secret.pdf, STOR acb.jpg
...
12. Briefly describe how you found the username-password pairs.
	Searched for certain protocols like POP, TCP and HTTP.
13. For each of the plaintext username-password pair that you found, identify the protocol used, server IP, the corresponding domain name (e.g., google.com), and port number.
	user: e129286, pass: 4.Ekkama, protocol: POP, serverIP: 144.122.144.179, domainName: imap.metu.edu.tr, port: pop3 (110)
	user: mbergeson@hjnews.com, pass: mb123on, protocol: POP, serverIP: 67.128.149.178, domainName: mail.newswest.com, port: pop3 (110)
	user: brewer, pass: 1qazxsw209simona12, protocol: POP, domainName: www.imartini.it, port: pop3 (110)
	user: dmartini@cutaway.it, pass: se1lasa, protocol: IMAP, domainName: mail.cutaway.it, port: 49773
...
15. How did you verified the successful username-password pairs?
	By looking through the tcp-stream, you can tell if it is successful or if there is an error in authentication.
16. In a few words, explain why I asked you not to log on to websites or services associated with the username-password pairs that you found.
	By logging onto the websites/services associated with the pairs, it means that you are showing yourself as someone who is a threat to security and can get in very real trouble. It is very illegal.
17. What advice would you give to the owners of the username-password pairs that you found so their account information would not be revealed "in-the-clear" in the future?
	Some advice would be to use a proxy or VPN, HTTPS and maybe also an antivirus.
18. Provide a listing of all IP addresses with corresponding hosts (hostname + domain name) that are in this PCAP set. Describe your methodology.
	Used command: tshark -r set2.pcap -q -z hosts,ipv4. This searches the pcap for hosts
  ...
  ip                                     frames:74220 bytes:65038587
    tcp                                  frames:71957 bytes:64533912
      ...
      ssl                                frames:5882 bytes:5747039
        tcp.segments                     frames:1805 bytes:2250458
